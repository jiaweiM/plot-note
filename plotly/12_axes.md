...
- [Axes](#axes)
  - [简介](#简介)
  - [对数坐标轴（Logaritmic Axes）](#对数坐标轴logaritmic-axes)
    - [log in px](#log-in-px)
    - [log in go](#log-in-go)
  - [categorical 类型转换](#categorical-类型转换)
    - [Subcategory (Multicategory) Axes](#subcategory-multicategory-axes)
  - [坐标轴属性](#坐标轴属性)
  - [刻度](#刻度)
    - [添加刻度（tick mark）](#添加刻度tick-mark)
    - [刻度数据](#刻度数据)
    - [起始刻度位置和刻度之间的距离](#起始刻度位置和刻度之间的距离)
    - [自定义刻度位置](#自定义刻度位置)
    - [刻度样式](#刻度样式)
    - [刻度标签](#刻度标签)
    - [刻度标签旋转角度和字体](#刻度标签旋转角度和字体)
    - [枚举所有刻度](#枚举所有刻度)
  - [网格线和零线](#网格线和零线)
    - [开关网格线](#开关网格线)
    - [开关零线](#开关零线)
    - [使用 update axis 方法设置](#使用-update-axis-方法设置)
    - [禁用 Express 创建的 figure 的网格线及零线](#禁用-express-创建的-figure-的网格线及零线)
    - [轴线](#轴线)
    - [坐标轴线镜像](#坐标轴线镜像)
    - [网格线样式](#网格线样式)
    - [零线样式](#零线样式)
